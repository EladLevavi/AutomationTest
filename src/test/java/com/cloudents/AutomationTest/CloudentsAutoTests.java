...
public class CloudentsAutoTests {
    ...
    public void token() throws InterruptedException {
        ...
        Assert.assertEquals(tokenPage.images.get(3).getAttribute("src"), "https://token.spitball.co/images/muscari/hevra.png");
        Thread.sleep(1000);
        scroll(tokenPage.downloadWhitepaper , 22);
        Assert.assertEquals(tokenPage.images.get(4).getAttribute("src"), "https://token.spitball.co/images/muscari/spitball_app.png");
        Thread.sleep(1000);
        scroll(tokenPage.downloadWhitepaper, 22);
        Assert.assertEquals(tokenPage.images.get(5).getAttribute("src"), "https://token.spitball.co/images/muscari/spitball_economy.png");
        Thread.sleep(1000);
        scroll(tokenPage.downloadWhitepaper, 45);
        Assert.assertEquals(tokenPage.images.get(6).getAttribute("src"), "https://token.spitball.co/images/muscari/Eidan.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(8).getAttribute("src"), "https://token.spitball.co/images/muscari/Ram.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(10).getAttribute("src"), "https://token.spitball.co/images/muscari/Jordan.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(12).getAttribute("src"), "https://token.spitball.co/images/muscari/Rob.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(14).getAttribute("src"), "https://token.spitball.co/images/muscari/Shlomi.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(16).getAttribute("src"), "https://token.spitball.co/images/muscari/Hadar.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(18).getAttribute("src"), "https://token.spitball.co/images/muscari/Tori.png");
        Thread.sleep(1000);
        Assert.assertEquals(tokenPage.images.get(20).getAttribute("src"), "https://token.spitball.co/images/muscari/Ola.png");
        Thread.sleep(1000);
        scroll(tokenPage.downloadWhitepaper, 22);
        Assert.assertEquals(tokenPage.images.get(22).getAttribute("src"), "https://token.spitball.co/images/muscari/partners.png");
        Thread.sleep(1000);
        */
